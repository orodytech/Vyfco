<section class="bg-white">
    ...
    <!----- Our Services -------->
            <section class="bg-gradient-to-br from-blue-600 to-purple-800 pt-20 pb-12">
                  ...
                  <div class="mt-16 py-4 px-4 w-72 bg-gradient-to-br from-blue-400 to-purple-600 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-110 transition duration-500 mx-auto md:mx-0">
                    <div class="w-sm">
                      ...
                      <div class="mt-4 text-yellow-200 text-center">
                        ...
                        <button class="mt-8 mb-4 py-2 px-14 rounded-full bg-white shadow-md text-blue-400 tracking-widest hover:bg-blue-500 hover:text-white transition duration-200"><a href="/services">MORE</a></button>
                      </div>
                    </div>
                  </div>
            ...
            {{-- How It Works --}}
            <section class="pt-10 bg-gradient-to-br from-blue-600 to-purple-800">
              <h1 class="text-center text-white text-5xl capitalize font-bold my-20">how it works</h1>
              <div class="flex rounded-lg mt-8 mx-10 justify-center bg-black bg-opacity-70">
                  <div class="flex flex-col py-20 px-4">
                    <div class="md:flex md:space-x-20 md:text-center">
                      <div class="flex flex-col py-4 border-2 hover:bg-black border-gray-400 md:h-68 md:w-72 rounded-lg mb-4  items-center">
                        <h1 class="text-yellow-300 hover:text-white hover:border-white border-4 border-yellow-300 w-10 h-10 rounded-full text-3xl text-center font-bold ">1</h1>
                        <h1 class="text-white hover:text-yellow-400 font-semibold md:text-2xl text-lg px-2 pt-2 text-center">Sign In or Create Account</h1>
                        <img src="{{ asset('img/how/register.png') }}" alt="" class="w-24 h-28 pt-5">
                      </div>
                      <div class="flex flex-col py-4 border-2 hover:bg-black border-gray-400 md:h-68 md:w-72 rounded-lg mb-4  items-center">
                        <h1 class="text-yellow-300 hover:text-white hover:border-white border-4 border-yellow-300 w-10 h-10 rounded-full text-3xl text-center font-bold ">2</h1>
                        <h1 class="text-white hover:text-yellow-400 font-semibold md:text-2xl text-lg px-2 pt-2 text-center">Submit Your Order Requirement</h1>
                        <img src="{{ asset('img/how/order.png') }}" alt="" class="w-24 h-28 pt-5">
                      </div>
                      <div class="flex flex-col py-4 border-2 hover:bg-black border-gray-400 md:h-68 md:w-72 rounded-lg mb-4  items-center">
                        <h1 class="text-yellow-300 hover:text-white hover:border-white border-4 border-yellow-300 w-10 h-10 rounded-full text-3xl text-center font-bold ">3</h1>
                        <h1 class="text-white hover:text-yellow-400 font-semibold md:text-2xl text-lg px-2 pt-2 text-center">Proceed to Payout</h1>
                        <img src="{{ asset('img/how/payout.png') }}" alt="" class="w-24 h-28 pt-5">
                      </div>
                    </div>
    
                    <div class="md:flex md:space-x-20">
                      <div class="flex flex-col py-4 border-2 hover:bg-black border-gray-400 md:h-68 md:w-72 rounded-lg mb-4  items-center">
                        <h1 class="text-yellow-300 hover:text-white hover:border-white border-4 border-yellow-300 w-10 h-10 rounded-full text-3xl text-center font-bold ">4</h1>
                        <h1 class="text-white hover:text-yellow-400 font-semibold md:text-2xl text-lg px-2 pt-2 text-center">Our Professionals Work on your Order</h1>
                        <img src="{{ asset('img/how/work.png') }}" alt="" class="w-24 h-28 pt-5">
                      </div>
                      <div class="flex flex-col py-4 border-2 hover:bg-black border-gray-400 md:h-68 md:w-72 rounded-lg mb-4  items-center">
                        <h1 class="text-yellow-300 hover:text-white hover:border-white border-4 border-yellow-300 w-10 h-10 rounded-full text-3xl text-center font-bold ">5</h1>
                        <h1 class="text-white hover:text-yellow-400 font-semibold md:text-2xl text-lg px-2 pt-2 text-center">We Deliver Your Order</h1>
                        <img src="{{ asset('img/how/deliver.png') }}" alt="" class="w-24 h-28 pt-5">
                      </div>
                      <div class="flex flex-col py-4 border-2 hover:bg-black border-gray-400 md:h-68 md:w-72 rounded-lg mb-4  items-center">
                        <h1 class="text-yellow-300 hover:text-white hover:border-white border-4 border-yellow-300 w-10 h-10 rounded-full text-3xl text-center font-bold ">6</h1>
                        <h1 class="text-white hover:text-yellow-400 font-semibold md:text-2xl text-lg px-2 pt-2 text-center">Accept the Work if Satisfactory</h1>
                        <img src="{{ asset('img/how/accept.png') }}" alt="" class="w-24 h-28 pt-5">
                      </div>
                    </div>
                    
                    <div class="md:flex md:space-x-20">
                      <div class="flex flex-col py-4 border-2 hover:bg-black border-gray-400 md:h-68 md:w-72 rounded-lg mb-4  items-center">
                        <h1 class="text-white hover:text-yellow-400 font-semibold md:text-2xl text-lg px-2 pt-2 text-center">Or Request for Modification</h1>
                        <img src="{{ asset('img/how/request.png') }}" alt="" class="w-24 h-28 pt-5">
                      </div>
                    </div>
                  </div>
              </div>
            ...
            <section class="bg-gradient-to-br from-blue-600 to-purple-800 pt-5">
                  <div class="w-full pb-10 px-5 text-gray-800">
                        <div class="w-full max-w-6xl mx-auto">
                            ...
                            <div class="md:flex bg-black bg-opacity-70 p-4 rounded-md space-x-4 items-start">
    ...
    <!-- why us -->
            <section class="bg-gradient-to-bl from-purple-800 to-blue-600 py-20">
              <h1 class="text-3xl md:text-5xl text-white text-center py-4 font-semibold">Why We Are The Best</h1>
                <div class="flex flex-col space-y-4 pb-2 lg:mt-10 lg:items-center">
                <div class="lg:flex space-y-4 lg:flex-1 lg:flex-row">
                      {{-- reason one --}}
                      <div class="shadow-md lg:w-80 flex items-center flex-col rounded-lg text-center bg-black mx-20 bg-opacity-80 px-2 pb-8 pt-2">
                        <img src="{{ asset('img/why/satisfaction.png') }}" alt="" class="h-14 w-14 mb-2">
                        <h1 class="text-xl font-semibold text-gray-200 capitalize">Customer Satisfication is guaranteed</h1>
                      </div>
    
                      {{-- reason two --}}
                      <div class="shadow-md lg:w-80 flex items-center flex-col rounded-lg text-center bg-black mx-20 bg-opacity-80 px-2 pb-8 pt-2">
                        <img src="{{ asset('img/why/turnaround.png') }}" alt="" class="h-14 w-14 mb-2">
                        <h1 class="text-xl font-semibold text-gray-200 capitalize">Very Quick and fast turn around</h1>
                      </div>
                </div>
                ...
                <div class="lg:flex space-y-4 lg:flex-1 lg:flex-row">
                      ...
                      <div class="shadow-md lg:w-80 flex items-center flex-col rounded-lg text-center bg-black mx-20 bg-opacity-80 px-2 pb-8 pt-2">
                        ...
                        <h1 class="text-xl font-semibold text-gray-200 capitalize">100% original content</h1>
                      </div>
                      
                      {{-- reason four --}}
                      <div class="shadow-md flex lg:w-80 items-center flex-col rounded-lg text-center bg-black mx-20 bg-opacity-80 px-2 pb-8 pt-2">
                        <img src="{{ asset('img/why/available.png') }}" alt="" class="h-14 w-14 mb-2">
                        <h1 class="text-xl font-semibold text-gray-200 capitalize">24/7 available support</h1>
                      </div>
                </div>
                ...
                <div class="">
                    ...
                    <div class="shadow-md lg:w-80 flex items-center flex-col rounded-lg text-center bg-black mx-20 bg-opacity-80 px-2 pb-8 pt-2">
                      ...
                      <h1 class="text-xl font-semibold text-gray-200 capitalize">customer friendly prices</h1>
                    </div>
                </div>        
                </div>
            </section>
    ...
    <!-------------- achievements--------->
            <section class="w-full px-20 py-10 bg-gray-200 bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500">
